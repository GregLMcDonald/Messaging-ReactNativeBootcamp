...
import { NetInfo, View, Text, Platform, StatusBar, StyleSheet } from 'react-native';
...
export default class Status extends React.Component {
	...
	async componentWillMount(){
		this.subscription = NetInfo.addEventListener( 'connectionChange', (status) => { this.handleChange });
